...
class Action {
    ...
    _pushPackage(version, name) {
        ...
        const pushCmd = `dotnet nuget push ${path.join(".", packageFilename)} --source ${this.nugetSource}/v3/index.json --api-key ${this.nugetKey} --skip-duplicate ${!this.includeSymbols ? "--no-symbols" : ""}`,
